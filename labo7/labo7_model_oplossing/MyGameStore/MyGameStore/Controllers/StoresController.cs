...
namespace MyGameStore.Controllers
{
    public class StoresController : ControllerBase
    {
        ...
        public IActionResult GetAllStores(string? nameFilter = null, SortFilter? filter = null, int pageNumber = 1, int pageLength = 10)
        {
            try
            {
                return Ok(storesService.GetAll(nameFilter, filter, pageNumber, pageLength));
            }
